...
n =100; p=0.3; q=0.3; sigma=0.5; model='uniform';
...
ReSync_parameters.stepsize = 1 / (n*p*(1 - q));
...
[~, ~, mean_error_SP_co, median_error_SP_co] = Rotation_Alignment(R_SP_co, R_orig);
[~, ~, mean_error_ReSync, median_error_ReSync] = Rotation_Alignment(R_ReSync, R_orig);
...
Results(9,:)={'Spectral_co', mean_error_SP_co, median_error_SP_co};
Results(10,:)={'ReSync', mean_error_ReSync, median_error_ReSync};
